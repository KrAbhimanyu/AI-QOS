...
def render_health_bar(health: float, label: str = "Health") -> None:
    ...
    <div style="margin: 12px 0;">
        ...
        ">
            ...
            <span style="font-size: 9px; color: #64748b;">50%</span>
            <span style="font-size: 9px; color: #64748b;">75%</span>
            <span style="font-size: 9px; color: #64748b;">90%</span>
        ...
        with cols[i]:
            ...
            ">
                <div style="
                    ...
                    margin-bottom: 6px;
                ">
                    {value:.1f}{'%' if isinstance(value, float) else ''}
                </div>
                <div style="
                    font-size: 11px;
                    color: #64748b;
    ...
    with col2:
        ...
        <div style="margin-bottom: 12px;">
            <div style="
                ...
                margin-bottom: 6px;
            ">
                <span style="font-size: 12px; color: #94a3b8;">Failure Rate</span>
                <span style="
                    font-size: 14px;
                    font-weight: 600;
                    font-family: 'JetBrains Mono', monospace;
                    color: {'#ef4444' if failure_rate > 0.05 else '#10b981'};
                ">{(failure_rate * 100):.2f}%</span>
            </div>
        </div>
        """, unsafe_allow_html=True)
        ...
        <div style="margin-bottom: 12px;">
            <div style="
                ...
                margin-bottom: 6px;
            ">
                <span style="font-size: 12px; color: #94a3b8;">Retry Rate</span>
                <span style="
                    font-size: 14px;
                    font-weight: 600;
                    font-family: 'JetBrains Mono', monospace;
                    color: {'#f59e0b' if retry_rate > 0.05 else '#10b981'};
                ">{(retry_rate * 100):.2f}%</span>
            </div>
        </div>
        """, unsafe_allow_html=True)
        ...
        ">
            ...
            <div>
                <div style="font-size: 14px; color: #f59e0b; font-weight: 600;">
                    {warnings} Active Warning{'s' if warnings > 1 else ''}
                </div>
